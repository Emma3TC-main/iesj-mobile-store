  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.detailBox}>
        <Text>
          <Text style={styles.bold}>Stock:</Text> {product.stock || 10} unidades
        </Text>
        <Text>
          <Text style={styles.bold}>Peso:</Text> {product.weight || "1.2 kg"}
        </Text>
        <Text>
          <Text style={styles.bold}>Dimensiones:</Text>{" "}
          {product.dimensions || "30x20x10 cm"}
        </Text>
      </View>
      {/* Botones */}
